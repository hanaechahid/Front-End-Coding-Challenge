...
const GithubRepository = (props) => {
    ...
    //Number of stars
    const stars = repository.stargazers_count > 999 ?  (repository.stargazers_count/ 1000).toFixed(1) : repository.stargazers_count;
    //number of issues
    const issues = repository.open_issues_count > 999 ? (repository.open_issues_count / 1000).toFixed(1) : repository.open_issues_count;
